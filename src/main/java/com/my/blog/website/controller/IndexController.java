...
public class IndexController extends BaseController {
    ...
    public String index(HttpServletRequest request, @PathVariable int p, @RequestParam(value = "limit", defaultValue = "12") int limit) {
        ...
        redisTemplate.boundHashOps("visitBlogIp").put("visitBlogIp",redisTemplate.boundHashOps("visitBlogIp").get("visitBlogIp") == null?1:Integer.parseInt(redisTemplate.boundHashOps("visitBlogIp").get("visitBlogIp").toString())+1);
        redisTemplate.boundHashOps("visitBlogIp").put(ip,1);
